...
namespace LocalizationEditorNET9
{
    public static class ExcelSerializer
    {
        ...
        public static InternalFormat Import(string FileName)
        {
            ...
            // EPPlus 5+ uses 0-based indexing, try by name first for reliability
            var Worksheet = Package.Workbook.Worksheets["Translation"] 
        ...
        public static void Export(InternalFormat data, string ExcelName)
        {
            ...
            Worksheet.Row(1).Style.Fill.BackgroundColor.SetColor(Color.Silver);
